...
('Information Architecture', '<p>Usability is driven by ease of use. When an inexperienced user enters your application, they should find their way naturally. A proper IA is imperative for this (books have been written on the subject). This websites IA is pictured below:</p> <img style="max-height:25em;width:auto" src="https://dl.dropboxusercontent.com/u/59744229/CIS%20Images/guide4.png">', 3),
('Wireframing', '<p>Plan your product through wireframing. The more you plan, the easier it will be to develop. Work on the wireframes with your team members and take into account your personas, information architecture and all information gathered to this point. Wireframes are not meant to be detailed and an example is below:</p><img style="max-height:25em;width:auto" src="https://dl.dropboxusercontent.com/u/59744229/CIS%20Images/guide7.png">', 3),
...
('Database ERD', '<p>The ERD below is the back-end foundation of this website.</p><img style="max-height:25em;width:auto" src="https://dl.dropboxusercontent.com/u/59744229/CIS%20Images/guide3.png">', 4),
